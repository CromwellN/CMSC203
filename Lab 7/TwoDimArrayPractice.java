/*Class: CMSC203 CRN 22445
 ...
 Summary of Description: The values in the two-dimensional array are randomly generated, and 
 will be different each time the program runs
 Due Date: 10/18/2020
   ...
   */
   public void printArray(){
    ...
    // Write your code here:
	   ...
	   for (int row = 0; row < intArray.length; row++) {
		   System.out.print(row + "\t");
		   for (int colum = 0; colum < intArray[row].length; colum++) {
			   System.out.print(intArray[row][colum] + " ");
			   animate(row, colum);
		   }
	        System.out.println( );
	   }
