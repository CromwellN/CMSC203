public class BevShopNoGUITest {
	public static void main(String[] args) {
		...
		if (!b.eligibleForMore())
			System.out.println("Maximum alcohol drink for this order"); // Maximum														// alcohol
													// drink														// for														// this														// order
		...
		if (b.validAge(b.getCurrentOrder().getCustomer().getAge())) {
			...
			System.out.println("Age not appropriate for alcohol drink!!"); // Age														// not													// appropriate														// for													// alcohol													// drink!!
